...
// let languages = countries.map((country) => country.languages)

// console.log(languages)
// let lg = []
// for (let language of languages) {
//     lg = lg.concat(language)
// }

// console.log(lg)


// let lgNew = new Set(lg)
// console.log(lgNew)

// const mostlanguage = []
// for (let item of lgNew) {
//     let count = lg.filter((ln) => {
//         return ln == item
//     }).length
...
//     mostlanguage.push(lgItem)

// }

// mostlanguage.sort((a, b) => {
...
// let [first,second,third,...rest] = skills
// console.log(first)
// console.log(second)
// console.log(rest)
...
// const [e,pi,gravity, humanbodytemp,waterboidTemp] = constants
// console.log(e,pi,gravity,humanbodytemp,waterboidTemp)
...
// const listUserhaveTwoskills = users.filter(({name,scores,skills,age}) => {
//     return skills.length < 2
// })

// console.log(listUserhaveTwoskills)



// countries.forEach(({name:n,capital:c,languages:l,population:p}) => {
//     console.log(n,c,l,p)
// })
...
//     const arrNew = arr.map(([name,skills,score])=>{
//         const object = {
//             name: name,
//             skills: skills,
//             score: score
...
let sortedPoints = points.filter((point) => {
    const pattern = /(-)?(0|1|3|4|8|12)/
...
const distance = Math.sqrt((+sortedPoints[sortedPoints.length - 1] - (+sortedPoints[0])) ** 2)
console.log(distance)


const patterCheckVariable = /^[a-zA-Z_][a-zA-Z0-9_]*$/

function is_valid_variable(variable) {
    return patterCheckVariable.test(variable)
}
...
function tenMostFrequentWords(para) {
    ...
    for (let word of wordSet) {
        ...
        arrWord.push(wordObj)
    }

    arrWord = arrWord.sort((a, b) => {
        if (a.count > b.count) return -1
        if (a.count < b.count) return 1
        return 0
    })
